...
class Article(models.Model):
    ...
    category = models.ForeignKey(to="Category", to_field="nid", null=True,on_delete=models.CASCADE,verbose_name='文章分类')
...
class ArticleDetail(models.Model):
    ...
    article = models.OneToOneField(to="Article", to_field="nid",on_delete=models.CASCADE,verbose_name='对应文章')
